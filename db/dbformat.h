...
namespace leveldb {
    ...
    struct ParsedInternalKey {
        ...
        ParsedInternalKey(const Slice &userKey,
                          ...
                          ValueType valueType) : userKey(userKey),
                                                 sequence(seq),
                                                 type(valueType) {
    ...
    // Append the serialization of "parsedInternalKey" to *result.
    ...
    // A internalKeyComparator for internal keys that uses a specified internalKeyComparator for
    ...
    public:
        explicit InternalKeyComparator(const Comparator *c) : userComparator(c) {}
    ...
    inline bool ParseInternalKey(const Slice &internal_key,
        ...
        result->userKey = Slice(internal_key.data(), n - 8);
