...
namespace leveldb {
    ...
    public:
        ...
        // The names are relative to "dirPath".
        // Original contents of *results are dropped.
        virtual Status GetChildren(const std::string &dirPath, std::vector<std::string> *result) = 0;
...
// Log the specified data to *logger if logger is non-null.
