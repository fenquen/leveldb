...
namespace leveldb {
    ...
    // A Table is a sorted map<string,string> ,immutable and persistent.
    // A Table may be safely accessed from multiple threads without external synchronization.
    class LEVELDB_EXPORT Table {
    public:
        // Attempt to open the table that is stored in bytes [0..fileSize_)
        // of "ldbFile", and read the metadata entries necessary to allow
